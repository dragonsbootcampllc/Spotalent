...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className={`w-full ${isScrolled ? 'bg-white/80 py-2 md:py-4 shadow-lg' : 'bg-transparent py-5 md:py-8'} transition-all duration-300 px-3 fixed z-[1000] top-0 left-0 right-0`}>
