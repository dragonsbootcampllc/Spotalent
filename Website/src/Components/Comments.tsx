...
const Comments: React.FC = () => {
  return (
    <div className="py-20 flex flex-col items-center gap-10 md:px-20">
      <h1 className="text-4xl font-semibold text-center max-w-lg mx-auto">Some comments people that hired by Spot Talents</h1>
      <div className="grid sm:grid-cols-1 max-md:px-12 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6 md:px-16 py-2">
