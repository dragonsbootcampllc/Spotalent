...
const JobsPost = () => {
    return (
        <div className="w-full max-w-4xl mx-auto bg-white rounded-xl shadow-md shadow-[#d6d1db]">
            <div className="p-6">
            ...
            <div className="p-6">
                <div>
                    {data.map(({
                        ...
                        >
                            <div className="">
                                <div className="mb-4 sm:mb-0 sm:mr-4 flex-shrink-0 flex flex-row">
                                    <img
                                        src={image}
                                        alt={`${firstName} ${lastName}`}
                                        className="w-full max-w-24 h-auto object-cover rounded-full"
                                    />
                                    <div className="m-4">
                                        <h2 className='text-sm'>{firstName} {lastName}</h2>
                                        <p className='text-xl text-[#111928] font-semibold'>{jobTitle}</p>
                                        <p className='text-sm text-[#111928]'>{city}</p>
                                    </div>
